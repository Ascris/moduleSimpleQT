...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Rectangle_t, stringdata) + ofs \
...
const QMetaObject Rectangle::staticMetaObject = {
    { &Figure::staticMetaObject, qt_meta_stringdata_Rectangle.data,
      qt_meta_data_Rectangle,  qt_static_metacall, 0, 0}
};
...
void *Rectangle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QWidget"))
        return static_cast< QWidget*>(const_cast< Rectangle*>(this));
