...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Projet\ 2015-20161.0.0/ && $(COPY_FILE) --parents global.h monDessin.h parser.tab.hpp Figure.hpp Option.hpp Rectangle.hpp Cercle.hpp Ligne.hpp .tmp/Projet\ 2015-20161.0.0/ && $(COPY_FILE) --parents lex.yy.c main.cpp monDessin.cpp Figure.cpp Option.cpp Rectangle.cpp Cercle.cpp Ligne.cpp .tmp/Projet\ 2015-20161.0.0/ && (cd `dirname .tmp/Projet\ 2015-20161.0.0` && $(TAR) Projet\ 2015-20161.0.0.tar Projet\ 2015-20161.0.0 && $(COMPRESS) Projet\ 2015-20161.0.0.tar) && $(MOVE) `dirname .tmp/Projet\ 2015-20161.0.0`/Projet\ 2015-20161.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Projet\ 2015-20161.0.0
